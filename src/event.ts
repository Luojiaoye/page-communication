...
module core {
	import Handler = Communication.Handler;
	...
	export class EventHandler extends Communication.Handler {
		...
		public static create(caller: any, method: Function, args: any = null, once: boolean = true): Handler {
			if (EventHandler._eventPool.length) return EventHandler._eventPool.pop().setTo(caller, method, args, once);
